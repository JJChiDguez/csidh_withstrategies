...
random_key = lambda m: [ random.randint(-m_i, m_i) for m_i in m]
            ...
            for Tuple in get_neighboring_sets(L, i):
                ...
                if C[i].get(Tuple) is None:
                    ...
                    alpha = [ (b, 
                        ...
                        2.0*sum([ C_xMUL[global_L.index(t)] for t in Tuple[b:] ])       # Weights corresponding with horizontal edges required for connecting the vertex (0,0) with the subtriangle with (i - b) leaves
                        ...
                        2.0*C_xMUL[global_L.index(Tuple[i - 1])]                          # Weights corresponding with horizontal edges required for connecting the vertex (0,0) with the subtriangle with (i - 1) leaves
                        )
                        ]
    ...
    for i in range(len(strategy)):
        ...
        if v[pos] > 0:     # Maximum number of degree-l_{pos} isogeny constructions?
            ...
            if isinfinity(ramifications[-1][0]) == False:
                ...
                ramifications[-1][0][0], ramifications[0][0][0] = fp_cswap(ramifications[-1][0][0], ramifications[0][0][0], b_i)
                ramifications[-1][0][1], ramifications[0][0][1] = fp_cswap(ramifications[-1][0][1], ramifications[0][0][1], b_i)
                ...
                ramifications[0][1] = xMUL(ramifications[0][1], E_i, pos)
                T_prime = list(ramifications[0][1])

                ramifications[0][0] = xEVAL(K, ramifications[0][0], pos)
                ramifications[0][1] = xEVAL(K, ramifications[0][1], pos)
                
                T[0], ramifications[0][0][0] = fp_cswap(T[0], ramifications[0][0][0], b_i)
                T[1], ramifications[0][0][1] = fp_cswap(T[1], ramifications[0][0][1], b_i)
                T_prime[0], ramifications[0][1][0] = fp_cswap(T_prime[0], ramifications[0][1][0], b_i)
                T_prime[1], ramifications[0][1][1] = fp_cswap(T_prime[1], ramifications[0][1][1], b_i)
                ...
                for j in range(1, len(moves) - 1, 1):
                    ...
                    # T_- (or T_)
                    T = xMUL(ramifications[j][0], E_i, pos)
                    ramifications[j][0] = xEVAL(K, ramifications[j][0], pos)
                    T[0], ramifications[j][0][0] = fp_cswap(T[0], ramifications[j][0][0], b_i)
                    T[1], ramifications[j][0][1] = fp_cswap(T[1], ramifications[j][0][1], b_i)
                    # T_+ or (T_+)
                    ramifications[j][1] = xMUL(ramifications[j][1], E_i, pos)
                    T = list(ramifications[j][1])
                    ramifications[j][1] = xEVAL(K, ramifications[j][1], pos)
                    T[0], ramifications[j][1][0] = fp_cswap(T[0], ramifications[j][1][0], b_i)
                    T[1], ramifications[j][1][1] = fp_cswap(T[1], ramifications[j][1][1], b_i)
