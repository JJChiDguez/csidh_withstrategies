...
def KPs(P, A, i):
    ...
    global FIELD_OPERATIONS_PERFORMED
    FIELD_OPERATIONS_PERFORMED += np.array([0.0, 0.0, 2.0])
...
def xISOG(A, K, i):
    ...
    for j in range(1, d, 1):
        ...
        FIELD_OPERATIONS_PERFORMED += np.array([2.0, 0.0, 0.0])
    ...
    for j in range(1, bits_of_l + 1):
        ...
        FIELD_OPERATIONS_PERFORMED += np.array([0.0, 2.0, 0.0])
    ...
    FIELD_OPERATIONS_PERFORMED += np.array([2.0, 6.0, 2.0])
...
def xEVAL(K, P, i):
    ...
    FIELD_OPERATIONS_PERFORMED += np.array([2.0, 2.0, 2.0])
