...
#include "addc.h"			// Addition chains, Public curve, public points T_{+} and T_{-}, and the list of prime factors l_i's
	...
	#if defined WITHDUMMY_1
		#include "strategy_withdummy_1.h"	// csidh with dummy operations and using only one torsion point T_{+}
	#elif defined WITHDUMMY_2
		#include "strategy_withdummy_2.h"	// csidh with dummy operations and using two torsion point T_{+} and T_{-}
	#elif defined DUMMYFREE
		#include "strategy_dummyfree.h"		// dummy-free csidh using two torsion points T_{+} and T_{-}
	#endif
#endif
