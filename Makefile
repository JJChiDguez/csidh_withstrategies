...
FILES_REQUIRED_IN_CSIDH=./lib/rng.c \
			...
			./lib/action_$(shell echo $(APPROACH) | tr A-Z a-z)_$(shell echo $(TYPE) | tr A-Z a-z).c \
			./main/csidh.c

OUTPUT_CSIDH=./bin/csidh
CFLAGS_CSIDH=-O3 -funroll-loops -fomit-frame-pointer -m64 -mbmi2 -DFP_$(BITLENGTH_OF_P) -D$(TYPE) -D$(APPROACH)
...
CFLAGS_ACTION=-O3 -funroll-loops -fomit-frame-pointer -m64 -mbmi2 -DFP_$(BITLENGTH_OF_P) -D$(TYPE) -D$(APPROACH) -lm
...
# -----------------------------------------------------------------------------------------------------------------------
# Using the files with extension .h and .c provided by  Hutchinson et al. 
...
help:
	@echo "\nusage: make csidh BITLENGTH_OF_P=[512] APPROACH=[SIMBA/STRATEGY] TYPE=[WITHDUMMY_1/WITHDUMMY_2/DUMMYFREE]"
	@echo "usage: make action_cost BITLENGTH_OF_P=[512] APPROACH=[SIMBA/STRATEGY] TYPE=[WITHDUMMY_1/WITHDUMMY_2/DUMMYFREE]"
	@echo "usage: make action_timing BITLENGTH_OF_P=[512] APPROACH=[SIMBA/STRATEGY] TYPE=[WITHDUMMY_1/WITHDUMMY_2/DUMMYFREE]"
